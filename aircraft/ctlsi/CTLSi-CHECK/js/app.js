(function(){
  ...
  var STORAGE_KEY = 'ctlsi_checklist_v1';
  var active = 'external';
  var state = loadState();
  ...
  function renderGroups(){
    ...
    category.groups.forEach(function(group,gi){
      ...
      if(group.warning){var warning=document.createElement('p');warning.className='group-warning';warning.textContent=group.warning;section.appendChild(warning);}
